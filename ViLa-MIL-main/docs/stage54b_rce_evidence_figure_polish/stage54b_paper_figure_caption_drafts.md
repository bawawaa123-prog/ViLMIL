...
matched-case concept ranking delta. Source: full=stage54_full_direct_export; wo_csg=stage54_wo_csg_direct_export. Context: case, slide=25024855B4, fold=0, true=NonAdenocarcinoma, pred=full=NonAdenocarcinoma; wo_csg=NonAdenocarcinoma, confidence=full=0.996; wo_csg=0.777. Matched Step54 direct exports show that CSG may alter concept ranking and confidence behavior in selected cases. This matched direct-export illustration is qualitative only and does not establish statistical significance or localization performance. Provenance note: Both full and wo_csg sides use Step54 direct export from the same Step54 export family.
