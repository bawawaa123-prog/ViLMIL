# Stage54 Summary Notes

## Main Metrics Snapshot

| variant | test_auc | test_acc | test_f1 | balanced_acc | pr_auc |
| --- | --- | --- | --- | --- | --- |
| full | 0.9702 | 0.9225 | 0.9145 | 0.9171 | 0.9444 |
| wo_csg | 0.9655 | 0.9215 | 0.9127 | 0.9134 | 0.9278 |
