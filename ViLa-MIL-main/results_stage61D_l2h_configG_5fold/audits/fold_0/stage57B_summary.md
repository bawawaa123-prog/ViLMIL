...
- visual residual 是否明显主导 final logits：`no_clear_dominance`。 依据：mean visual ratio=0.3575，median=0.3287，ratio>0.5 占比=0.1340。
...
python scripts/analysis/build_stage57B_logit_contribution_audit.py \
  --output_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage61D_l2h_configG_5fold/audits/fold_0 \
  --split test \
  --fold 0 \
  --run_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage61D_l2h_configG_5fold/rce_v2_rcD_l2hG_5fold_e20_s1
```
