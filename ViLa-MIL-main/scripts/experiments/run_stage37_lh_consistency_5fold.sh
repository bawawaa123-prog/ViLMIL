...
RESULTS_DIR="${RESULTS_DIR:-results_stage37}"
SEED="${SEED:-1}"
...
run_variant() {
  local variant="$1"
  local exp_code="lh_consistency_${variant}_5fold_e${MAX_EPOCHS}"
  local lh_lambda="off"
  local lh_margin="off"
  ...
  echo "[Run] Stage37 Low-High Consistency 5-fold"
...
case "${VARIANT}" in
  skeleton|lh_l0001_m0|lh_l0005_m0|lh_l001_m0|lh_l0005_m002|lh_l001_m002|lh_l001_m005|lh_l005_m0|lh_l005_m005)
    run_variant "${VARIANT}"
    ;;
  all)
