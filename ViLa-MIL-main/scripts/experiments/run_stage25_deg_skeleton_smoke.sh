...
RESULTS_DIR="${RESULTS_DIR:-results_stage25}"
SEED="${SEED:-1}"
...
echo "[Done] DEG-MIL skeleton smoke test finished."
echo "[Done] Results directory: ${RESULTS_DIR}/deg_skeleton_smoke_s${SEED}"
