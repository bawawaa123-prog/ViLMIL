...
RESULTS_DIR="${RESULTS_DIR:-results_stage57C_rce_v2_copy_reproduction}"
SEED="${SEED:-1}"
...
run_variant() {
  ...
  case "${variant}" in
    rq8)
      exp_code="rce_v2_copy_csg_a01_rq8_5fold_e20"
      prototype_number="8"
      ;;
    rq16)
      exp_code="rce_v2_copy_csg_a01_rq16_5fold_e20"
      prototype_number="16"
      ;;
    rq32)
      exp_code="rce_v2_copy_csg_a01_rq32_5fold_e20"
      prototype_number="32"
      ;;
    *)
  ...
  echo "[Run] Stage57C RCE-v2 copy reproduction 5-fold"
