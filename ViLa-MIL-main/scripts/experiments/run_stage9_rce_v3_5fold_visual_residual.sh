...
run_variant() {
  ...
  case "${variant}" in
    vr_a01)
      exp_code="rce_mil_v3_prior_calib_vr_a01_5fold_e20"
      extra_args=(
      ...
      ;;
    vr_a005)
      exp_code="rce_mil_v3_prior_calib_vr_a005_5fold_e20"
      extra_args=(
        --rce_use_logit_calibration
        --rce_use_concept_prior
        --rce_use_visual_residual
    ...
    *)
      ...
      echo "[Error] Supported VARIANT values: vr_a01, vr_a005, all" >&2
      exit 1
      ;;
  esac

  echo "[Run] RCE-MIL v3 visual residual 5-fold variant: ${variant}"
