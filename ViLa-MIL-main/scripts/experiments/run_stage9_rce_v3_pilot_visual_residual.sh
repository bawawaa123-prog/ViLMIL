...
VARIANT="${VARIANT:-prior_calib_vr_a01}"
...
run_variant() {
  ...
  case "${variant}" in
    prior_calib_vr_a01)
      exp_code="rce_mil_v3_prior_calib_vr_a01_fold0_e20"
      extra_args=(
        ...
        --rce_visual_residual_init 0.1
      )
      ;;
    prior_calib_vr_a005)
      exp_code="rce_mil_v3_prior_calib_vr_a005_fold0_e20"
      extra_args=(
        --rce_use_logit_calibration
        --rce_use_concept_prior
        --rce_use_visual_residual
      ...
      ;;
    prior_calib_vr_a02)
      exp_code="rce_mil_v3_prior_calib_vr_a02_fold0_e20"
      extra_args=(
        --rce_use_logit_calibration
        --rce_use_concept_prior
        --rce_use_visual_residual
        --rce_logit_scale_init 10.0
        --rce_concept_prior_strength 1.0
        --rce_visual_residual_init 0.2
      )
      ;;
    *)
      echo "[Error] Unsupported variant: ${variant}" >&2
      echo "[Error] Supported VARIANT values: prior_calib_vr_a01, prior_calib_vr_a005, prior_calib_vr_a02, all" >&2
      exit 1
      ;;
  esac

  echo "[Run] RCE-MIL v3 visual residual variant: ${variant}"
...
case "${VARIANT}" in
  prior_calib_vr_a01|prior_calib_vr_a005|prior_calib_vr_a02)
    run_variant "${VARIANT}"
    ;;
  all)
    run_variant prior_calib_vr_a01
    run_variant prior_calib_vr_a005
    run_variant prior_calib_vr_a02
    ;;
  *)
    echo "[Error] Unsupported VARIANT: ${VARIANT}" >&2
    echo "[Error] Supported VARIANT values: prior_calib_vr_a01, prior_calib_vr_a005, prior_calib_vr_a02, all" >&2
