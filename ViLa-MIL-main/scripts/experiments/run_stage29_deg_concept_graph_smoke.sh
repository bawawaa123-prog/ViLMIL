...
RESULTS_DIR="${RESULTS_DIR:-results_stage29}"
SEED="${SEED:-1}"
...
CMD=(
  ...
  --exp_code deg_concept_graph_smoke
...
echo "[Done] DEG-MIL concept graph smoke test finished."
echo "[Done] Results directory: ${RESULTS_DIR}/deg_concept_graph_smoke_s${SEED}"
