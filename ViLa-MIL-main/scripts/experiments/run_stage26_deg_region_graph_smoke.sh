...
RESULTS_DIR="${RESULTS_DIR:-results_stage26}"
SEED="${SEED:-1}"
...
CMD=(
  ...
  --exp_code deg_region_graph_smoke
...
echo "[Done] DEG-MIL region graph smoke test finished."
echo "[Done] Results directory: ${RESULTS_DIR}/deg_region_graph_smoke_s${SEED}"
