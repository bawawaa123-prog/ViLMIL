...
- visual residual 是否明显主导 final logits：`no_clear_dominance`。 依据：mean visual ratio=0.2829，median=0.2824，ratio>0.5 占比=0.0155。
- CSG 是否有可观察贡献：`yes`。 依据：mean csg ratio=0.0003，csg_only acc=0.7268041237113402。
- 下一步建议：`dynamic CSG`。
...
python scripts/analysis/build_stage57B_logit_contribution_audit.py \
  --output_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage60C_ccra_configD_5fold/audits/fold_2 \
  --split test \
  --fold 2 \
  --run_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage60C_ccra_configD_5fold/rce_v2_rcD_ccraD_5fold_e20_s1
```
