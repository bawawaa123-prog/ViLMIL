...
RESULTS_DIR="/private/ljh-data/shared/Linux_school/ViLMIL/ViLa-MIL-main/experiment_outputs/stage_results/results_stage64K_controlled_repro_diagnostics/runs/results_stage64K_oldcode_fold2"
EXP_CODE="stage64K_oldcode_fold2"
...
echo "Git commit: $(git -c safe.directory=/private/ljh-data/shared/Linux_school/ViLMIL_step58C_c1253e8 -C "${PROJECT_ROOT}/.." rev-parse HEAD)"
