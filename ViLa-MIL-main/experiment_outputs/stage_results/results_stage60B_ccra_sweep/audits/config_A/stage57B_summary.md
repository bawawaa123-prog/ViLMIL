...
- visual residual 是否明显主导 final logits：`no_clear_dominance`。 依据：mean visual ratio=0.3318，median=0.2690，ratio>0.5 占比=0.1856。
- CSG 是否有可观察贡献：`yes`。 依据：mean csg ratio=0.0024，csg_only acc=0.7216494845360825。
- 下一步建议：`dynamic CSG`。
...
python scripts/analysis/build_stage57B_logit_contribution_audit.py \
  --output_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage60B_ccra_sweep/audits/config_A \
  --split test \
  --fold 0 \
  --run_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage60B_ccra_sweep/rce_v2_rcD_ccra_A_fold0_s1
```
