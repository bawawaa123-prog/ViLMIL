...
- visual residual 是否明显主导 final logits：`no_clear_dominance`。 依据：mean visual ratio=0.2410，median=0.2338，ratio>0.5 占比=0.0412。
- CSG 是否有可观察贡献：`yes`。 依据：mean csg ratio=0.0007，csg_only acc=0.5773195876288659。
- 下一步建议：`dynamic CSG`。
...
python scripts/analysis/build_stage57B_logit_contribution_audit.py \
  --output_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage61D_l2h_configG_5fold/audits/fold_2 \
  --split test \
  --fold 2 \
