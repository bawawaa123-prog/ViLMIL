...
- visual residual 是否明显主导 final logits：`no_clear_dominance`。 依据：mean visual ratio=0.3100，median=0.2509，ratio>0.5 占比=0.2021。
- CSG 是否有可观察贡献：`yes`。 依据：mean csg ratio=0.0011，csg_only acc=0.6373056994818653。
- 下一步建议：`dynamic CSG`。
...
python scripts/analysis/build_stage57B_logit_contribution_audit.py \
  --output_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage61D_l2h_configG_5fold/audits/fold_3 \
  --split test \
  --fold 3 \
