...
- visual residual 是否明显主导 final logits：`yes`。 依据：mean visual ratio=0.7196，median=0.6985，ratio>0.5 占比=0.9381。
- CSG 是否有可观察贡献：`yes`。 依据：mean csg ratio=0.0000，csg_only acc=0.6030927835051546。
- 下一步建议：`residual-constrained RCE`。
...
python scripts/analysis/build_stage57B_logit_contribution_audit.py \
  --output_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage57B_logit_contribution_audit \
  --split test \
  --fold 0 \
  --run_dir /home/ljh/ViLMIL/ViLa-MIL-main/results_stage23/rce_v4_csg_a01_rq16_5fold_e20_s1
```
